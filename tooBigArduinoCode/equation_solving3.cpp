...
namespace equation_3 {
  // would be 208 bytes stack size
  Number a;
  Number b;
  Number c;
  ...
  void solve_equation_3(NumberArgument A,    NumberArgument B,    NumberArgument C,    NumberArgument D, 
...
void solve_equation(NumberArgument A,    NumberArgument B,    NumberArgument C,    NumberArgument D, 
                    NumberPointer zero1, NumberPointer zero2, NumberPointer zero3) {
  equation_3::solve_equation_3(A, B, C, D, zero1, zero2, zero3);
}
