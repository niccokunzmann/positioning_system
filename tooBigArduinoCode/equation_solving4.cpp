...
namespace equation_4 {
  // would be 320 bytes stack size
  Number a;
  Number b;
  Number c;
  Number d;
  ...
  void solve_equation_4(NumberArgument e,    NumberArgument f,    NumberArgument g,    NumberArgument h,    NumberArgument i, 
...
void solve_equation(NumberArgument e,    NumberArgument f,    NumberArgument g,    NumberArgument h,    NumberArgument i, 
                    NumberPointer zero1, NumberPointer zero2, NumberPointer zero3, NumberPointer zero4) {
  equation_4::solve_equation_4(e, f, g, h, i, zero1, zero2, zero3, zero4);
}