...
namespace equation_2 {
  // would be 20 bytes stack size
  Number p;
  Number q;
  Number D;
  Number root_of_D;
  ...
  void solve_equation_2(NumberArgument c,    NumberArgument d,    NumberArgument e, 
...
void solve_equation(NumberArgument c,    NumberArgument d,    NumberArgument e, 
                    NumberPointer zero1, NumberPointer zero2) {
  equation_2::solve_equation_2(c, d, e, zero1, zero2);
}